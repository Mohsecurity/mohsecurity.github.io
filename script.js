    ...
    n.addEventListener("keypress", function (i) {
      if (13 === i.keyCode && "" !== (i = n.value.trim())) {
        if (
          ...
          window.location.href = "https://github.com/mohsecurity254";
          ...
          window.location.href = "mailto:mohsecurity254@proton.me";
        else if ("steam" === i || "st" === i)
          window.location.href = "https://steamcommunity.com/id/";
          ...
          let n = [],
            ...
            l = [],
            t = [];
          fetch("https://github.com/mohsecurity254/Darkweb-website-development")
            .then((n) => n.json())
            .then((e) => {
